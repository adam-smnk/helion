...
# @helion.kernel(static_shapes=True, config=helion.Config(block_sizes=[256, 256, 16], indexing='tensor_descriptor', l2_groupings=[8], loop_orders=[[1, 0]], num_stages=8, num_warps=32, pid_type='flat', range_flattens=[None, False], range_multi_buffers=[None, None], range_num_stages=[0, 0], range_unroll_factors=[0, 0], range_warp_specializes=[]))
